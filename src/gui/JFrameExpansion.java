...
public class JFrameExpansion extends JFrameImagen{
    ...
    public void crear(){
        ...
        //System.out.println(seleccionExp.equals("Lineal"));
        //if(seleccion.equals("Umbralizacion")) crearLineal();
        if(seleccion.equals("Umbralizacion")) actualizarImagen();
        if(seleccion.equals("Lineal")) crearLineal();
        else if(seleccion.equals("Exponencial")) crearExponenecial();
        else if(seleccion.equals("Logaritmica")){
            JFrameImagen j = new JFrameImagen(this.imagen);
        }
    ...
    public void crearExponenecial(){
        ...
        menu3.setText("Histograma");
        //slider
        int valor = (int) (this.umbral*10);
        JSlider slider1 = new JSlider(0,1000,valor);
        slider1.setMajorTickSpacing(50);
        slider1.setMinorTickSpacing(10);
        slider1.setPaintLabels(true);
        slider1.setPaintTicks(true);
        ...
        JLabel txtValor1 = new JLabel(String.valueOf(this.umbral1));
        //JLabel txtValor1 = new JLabel(this.umbral1<10 ? "00"+String.valueOf(this.umbral1) : this.umbral1<100 ? "0"+String.valueOf(this.umbral1) : String.valueOf(this.umbral1));
    ...
    public void crear(int n){
        ...
        //if(seleccion.equals("Lineal")) actualizarImagenLinal();
